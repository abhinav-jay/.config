...
(custom-set-variables
 ...
 '(package-selected-packages
   '(nord-theme timu-spacegrey-theme org-notify projectile treemacs color-theme-sanityinc-solarized solarized-theme company zenburn-theme monokai-theme dracula-theme)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#282a36" :foreground "#f8f8f2" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 140 :width normal :foundry "PfEd" :family "ProggyClean")))))
