(deftheme Tokyonight-transparent
  "Created 2024-12-27.")

(custom-theme-set-faces
 'Tokyonight-transparent
 '(default ((t (:inherit nil :extend nil :stipple nil :background "none" :foreground "#FFFFFF" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 1 :width normal :foundry "sans-serif" :family "proggyclean"))))
 ...
 '(header-line ((t (:box (:line-width (4 . 4) :color "grey75" :style nil)))))
 '(tooltip ((((class color)) (:inherit (variable-pitch) :foreground "black" :background "lightyellow")) (t (:inherit (variable-pitch)))))
 '(mode-line ((t (:box (:line-width (6 . 6) :color "grey75" :style nil)))))
 '(mode-line-buffer-id ((t (:weight bold))))
 '(mode-line-emphasis ((t (:weight bold))))
 '(mode-line-highlight ((t (:box (:line-width (1 . 1) :color "unspecified-fg" :style nil)))))
 '(mode-line-inactive ((t (:box (:line-width (6 . 6) :color "grey30" :style nil)))))
...
(provide-theme 'Tokyonight-transparent)
