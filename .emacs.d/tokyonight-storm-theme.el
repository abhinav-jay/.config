...
(custom-theme-set-faces
 'tokyonight-storm
 '(cursor ((t (:background " #24283b"))))
 '(fixed-pitch ((t (:family "proggyclean"))))
 '(variable-pitch ((t (:family "Sans Serif"))))
 '(escape-glyph ((t (:foreground " #2ac3de"))))
 '(minibuffer-prompt ((t (:foreground " #2ac3de"))))
 '(highlight ((t (:background " #7aa2f7"))))
 '(region ((t (:extend t :background "    #7aa2f7"))))
 ...
 '(fringe ((t (:background "#222436"))))
 '(header-line ((t (:box (:line-width (4 . 4) :color "#1e2030" :style nil)))))
 '(tooltip ((((class color)) (:inherit (variable-pitch) :foreground "black" :background "lightyellow")) (t (:inherit (variable-pitch)))))
 '(mode-line ((t (:box (:line-width (6 . 6) :color "#1e2030" :style nil)))))
 '(mode-line-buffer-id ((t (:weight bold))))
 '(mode-line-emphasis ((t (:weight bold))))
 '(mode-line-highlight ((t (:box (:line-width (1 . 1) :color "#c8d3f5" :style nil)))))
 '(mode-line-inactive ((t (:box (:line-width (6 . 6) :color "#1e2030" :style nil)))))
 ...
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#414868" :foreground "#a9b1d6" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 113 :width normal :foundry "PfEd" :family "DejaVu Sans Mono")))))
