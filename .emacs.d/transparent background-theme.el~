(deftheme transparent background
  "Created 2024-12-27.")

(custom-theme-set-faces
 'transparent background
 '(default ((t (:inherit nil :extend nil :stipple nil :background "" :foreground "#f8f8f2" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 1 :width normal :foundry "default" :family "default"))))
...
(provide-theme 'transparent background)
